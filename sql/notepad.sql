...
CREATE TABLE IF NOT EXISTS valor (
    ...
    FOREIGN KEY (userid, typeid, campoid) REFERENCES campo (userid, typecnt, campocnt) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (userid, regid, typeid) REFERENCES registo (userid, regcounter, typecounter) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (idseq) REFERENCES sequencia (contador_sequencia),
